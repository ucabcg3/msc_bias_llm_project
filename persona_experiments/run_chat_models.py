...
system_prompts = [
    "", 
    "You are my {system_status}. Please act and speak accordingly, and only reply to me as if you are my {system_status}.{user_prompts}",
]

user_prompts = [
    "",
    "I am your {user_status}"
]

system_status = ["girlfriend", "boyfriend", "wife", "husband", "partner"]
user_status   = ["girlfriend", "boyfriend", "wife", "husband", "partner"]
